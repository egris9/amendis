     ...
     <main>
        ...
        <div class="max-w-[85%] mx-auto mb-5 flex w-full flex-col items-start">
            <div class="mb-4">
                ...
                <asp:TextBox ID="NumeroAoTextBox" runat="server" CssClass="h-10 w-64 rounded border px-5"></asp:TextBox>
            </div>
            <div class="mb-4">
                <label for="Designation" class="block text-lg font-medium">Désignation:</label>
                <asp:TextBox ID="DesignationTextBox" runat="server" CssClass="h-10 w-64 rounded border px-5"></asp:TextBox>
            </div>
            <div class="mb-4">
                <label for="PdfFile" class="block text-lg font-medium">Fichier PDF:</label>
                <asp:FileUpload ID="PdfFileUpload" runat="server" CssClass="h-11 max-w-64 rounded border px-1" />
            </div>
